	...
	<view>
		...
		<view class="box-contaniner">
			...
			<view class="end-cont" :class="{dis:arcbarNum == 0}" >
				...
				<view class="arcbarChart-content">
					<view class="arcbar-text" style="width: 50%;">全国足球销量占比</view>
					<view class="arcbar-text" style="width: 50%;">全省足球销量占比</view>
				</view>
			</view>
			<view class="end-cont" :class="{dis:arcbarNum == 1}">		　						 
				...
				<view class="arcbarChart-content">
					<view class="arcbar-text" style="width: 50%;">全国篮球销量占比</view>
					<view class="arcbar-text" style="width: 50%;">全省篮球销量占比</view>
				</view>
			</view>				
		</view>		
