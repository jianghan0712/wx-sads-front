...
<script>
	...
	export default {
		...
		created() {
			...
			// this.selectWeek('2021-01-01','2021-01-05')
			// 选中某一天
		...
		methods: {
			...
			choiceDate(weeks) {
				...
				console.log("fulldate=",fulldate,", tDay=",tDay)
			...
			// 	debugger
			// 	var begin = this.getNextDate(fulldate, tday-1);
			// 	var end = this.getNextDate(fulldate, 6-tDay);
			// 	// console.log('monday:', monday);
			// 	// console.log('sunday:', sunday);
			// 	this.date.date = begin + "~~" + end;
			// },
			/**
			 * 回到今天
			 */
